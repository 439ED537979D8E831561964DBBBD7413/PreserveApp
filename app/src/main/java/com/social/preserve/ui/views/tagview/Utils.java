...
//        g = Math.round(g * factor);
    ...
    public static int[] getColorSets(Context context){
        int[] colors=new int[]{context.getResources().getColor(R.color.dark_red),context.getResources().getColor(R.color.pink),
                context.getResources().getColor(R.color.shitcoinyellow),context.getResources().getColor(R.color.blue_purpple)};
        return colors;
    }
}
