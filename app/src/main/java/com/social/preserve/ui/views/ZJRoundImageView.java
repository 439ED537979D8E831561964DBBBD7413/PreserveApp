...
public class ZJRoundImageView extends android.support.v7.widget.AppCompatImageView {
    /**
     * 图片的类型，圆形or圆角
     */
    private int type;
    ...
    public ZJRoundImageView(Context context) {
        this(context, null);
    }

    public ZJRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZJRoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ZJRoundImageView, defStyleAttr, 0);

        type = a.getInt(R.styleable.ZJRoundImageView_type, TYPE_OVAL);
        mBorderColor = a.getColor(R.styleable.ZJRoundImageView_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.ZJRoundImageView_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.ZJRoundImageView_corner_radius, dp2px(10));
        mLeftTopCornerRadius = a.getDimension(R.styleable.ZJRoundImageView_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.ZJRoundImageView_leftBottom_corner_radius,0);
        mRightTopCornerRadius = a.getDimension(R.styleable.ZJRoundImageView_rightTop_corner_radius,0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.ZJRoundImageView_rightBottom_corner_radius,0);
     ...
     * 默认为圆形图片
     */
    public ZJRoundImageView setType(int imageType) {
     ...
     * 设置圆角图片的圆角大小
     */
    public ZJRoundImageView setCornerRadius(int cornerRadius) {
     ...
     * 设置圆角图片的左上圆角大小
     */
    public ZJRoundImageView setLeftTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右上圆角大小
     */
    public ZJRoundImageView setRightTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的左下圆角大小
     */
    public ZJRoundImageView setLeftBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右下圆角大小
     */
    public ZJRoundImageView setRightBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置描边宽度
     */
    public ZJRoundImageView setBorderWidth(int borderWidth) {
     ...
     * 设置描边颜色
     */
    public ZJRoundImageView setBorderColor(int borderColor) {
